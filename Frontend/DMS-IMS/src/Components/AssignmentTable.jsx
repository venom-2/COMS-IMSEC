...
import AssignmentMarksgrid from "./AssignmentMarksgrid";

function createData(id, name, year, branch, rollno, a1, a2, a3, a4, a5) {
    return {
        id,
        name,
        year,
...
const rows = [
    createData(1, "Akshat", 4, "CS", 2101430120000, "19/20", "20/20", "18/20", "17/20", "15/20"),
    createData(2, "Krishna", 4, "CS", 2101430120001, "19/20", "20/20", "18/20", "17/20", "15/20"),
    createData(3, "Khushi", 4, "CS", 2101430120002, "19/20", "20/20", "18/20", "17/20", "15/20"),
    createData(4, "Divyanshi", 4, "CS", 2101430120003, "19/20", "20/20", "18/20", "17/20", "15/20"),
    createData(5, "Harsh", 4, "CS", 2101430120004, "19/20", "20/20", "18/20", "17/20", "15/20"),
    createData(6, "Ayush", 4, "CS", 2101430120005, "19/20", "20/20", "18/20", "17/20", "15/20"),
    createData(7, "Lalit", 4, "CS", 2101430120006, "19/20", "20/20", "18/20", "17/20", "15/20"),
    createData(8, "Chandni", 4, "CS", 2101430120007, "19/20", "20/20", "18/20", "17/20", "15/20"),
    createData(9, "Shweta", 4, "CS", 2101430120008, "19/20", "20/20", "18/20", "17/20", "15/20"),
    createData(10, "Sunny", 4, "CS", 2101430120009, "19/20", "20/20", "18/20", "17/20", "15/20"),
    createData(11, "Amit", 4, "CS", 2101430120010, "19/20", "20/20", "18/20", "17/20", "15/20"),
    createData(12, "Aditya", 4, "CS", 2101430120011, "19/20", "20/20", "18/20", "17/20", "15/20"),
    createData(13, "Krishna Kant", 4, "CS", 2101430120012, "10/60", "10/60", "60/60", "60/60", "60/60"),
];
        ...
        <Box sx={{ width: "100%", mt: 2 }}>
            <Paper sx={{ width: "100%", mb: 2 }}>
                            ...
                            {visibleRows.map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="center">{row.a4}</TableCell>
                                        <TableCell align="center">{row.a5}</TableCell>
                                    </TableRow>
                                );
                            })}
                            {emptyRows > 0 && (
                ...
                >
                    ...
                    >
                        <Container>
                            ...
                            >
                                Select Subject to Upload Assignment Marks
                            </Typography>
                ...
                >
                    ...
                    >
                        <AssignmentMarksgrid subjectName="Digital Electronics"/>
                    </Box>
                </Modal>
            </Paper>
        </Box>
